...
import { ClipboardList, Check, Plus, Edit2, Trash2, X, Flag, Calendar, AlertCircle, Filter, SortAsc, Zap, Bell, Star, Clock, ChevronDown, GripVertical, Users, TrendingUp } from 'lucide-react';
...
export const TasksSection = ({ userSettings, selectedDate, weekNumber, onModalStateChange, pendingRoomId, onPendingRoomHandled }) => {
  ...
  useEffect(() => {
    if (onModalStateChange) {
      ...
      onModalStateChange(isAddModalOpen || isEditModalOpen || isPrepareForLectureModalOpen || roomModals);
    }
  }, [isAddModalOpen, isEditModalOpen, isPrepareForLectureModalOpen, isCreateRoomModalOpen, isRoomDetailModalOpen, onModalStateChange]);
